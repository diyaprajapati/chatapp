                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <Input
                      ...
                      disabled={isLoading}
                      className="h-14 text-base bg-white/70 dark:bg-slate-700/70 border-slate-200/50 dark:border-slate-600/50 focus:border-blue-500 dark:focus:border-blue-400 transition-all duration-300 rounded-xl backdrop-blur-sm"
                    />
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        disabled={isLoading}
                        className="h-14 text-base bg-white/70 dark:bg-slate-700/70 border-slate-200/50 dark:border-slate-600/50 focus:border-blue-500 dark:focus:border-blue-400 transition-all duration-300 rounded-xl backdrop-blur-sm pr-12"
                      />
                      <button
                        type="button"
